 ...
 */
public class TnovaBillingModel {
    // used for mapping
    ...
    public Double computeCost(double time) {
        ...
        switch (periodPolicy) {
            ...
            case 'W':
                ...
                break;
            case 'M':
                final int secondsPerMonth = secondsInMonth();
     ...
     * @return
     */
    private static int secondsInMonth() {
        DateTime dateTime = new DateTime(DateTime.now().getYear(), DateTime.now().getMonthOfYear(), 14, 12, 0, 0, 000);
