 ...
 * Description: list of CloudStack usage types, both Vanilla and Extended
 */
public class CloudStackUsageTypes {
    ...
    /**
     * Access list of Extended usage record types
     *
     * @return list
     */
    public static List<String> getExtendedList() {
        ...
        list.add(new VPCUsageData().getMeterName());
        list.add(new NetworkSegmentUsageData().getMeterName());
        list.add(new RemoteVPNUsageData().getMeterName());
        list.add(new SiteToSiteVPNUsageData().getMeterName());
        list.add(new VMCpuUsageData().getMeterName());
        list.add(new VMRamUsageData().getMeterName());
