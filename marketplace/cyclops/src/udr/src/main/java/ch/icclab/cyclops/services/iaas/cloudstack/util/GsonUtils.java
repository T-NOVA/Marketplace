 ...
 *     under the License.
 */
package ch.icclab.cyclops.services.iaas.cloudstack.util;

import ch.icclab.cyclops.services.iaas.cloudstack.model.*;
import ch.icclab.cyclops.services.iaas.cloudstack.model.safeswisscloud.*;
...
public class GsonUtils {
    ...
    final static Logger logger = LogManager.getLogger(GsonUtils.class.getName());
    ...
    private static final GsonFireBuilder builder = new GsonFireBuilder()
            .registerTypeSelector(UsageData.class, new TypeSelector<UsageData>() {
                ...
                public Class<? extends UsageData> getClassForElement(JsonElement readElement) {
                    ...
                    switch (usagetype) {
                        // custom Usage Service types (SafeSwissCloud)
                        case -1:
                            return VPCUsageData.class;
                        case -2:
                            return NetworkSegmentUsageData.class;
                        case -3:
                            return RemoteVPNUsageData.class;
                        case -4:
                            return SiteToSiteVPNUsageData.class;
                        case -5:
                            return VMCpuUsageData.class;
                        case -6:
                            return VMRamUsageData.class;
                        // vanilla CloudStack types
                        case 1:
                        case 2:
