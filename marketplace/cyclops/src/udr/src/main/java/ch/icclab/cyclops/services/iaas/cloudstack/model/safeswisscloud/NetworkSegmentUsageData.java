 ...
 * Description: POJO object for Network Segments usage records (type -2)
 */
public class NetworkSegmentUsageData extends UsageData {
    ...
    public String getMeterName() {
        return "cloudstack.network.segments.hours";
    }
}
