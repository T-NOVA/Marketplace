...
public class CloudStackPuller {
    ...
    private String signPage(DateInterval dates, Integer page, Boolean extendedCloudStack) {
        APICall apiCall = (extendedCloudStack) ? getCustomListUsageRecordsCall(dates, page) : getListUsageRecordsCall(dates, page);
     ...
     */
    private Set<Callable<List<Point>>> getCallables(DateInterval dates, Integer remainingPages, Boolean extendedCloudStack) {
