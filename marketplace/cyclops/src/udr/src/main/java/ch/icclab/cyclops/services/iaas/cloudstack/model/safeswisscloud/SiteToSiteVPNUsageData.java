 ...
 * Description: POJO object for Site to Site VPNs usage records (type -4)
 */
public class SiteToSiteVPNUsageData extends UsageData {
    private String name;
    ...
    public String getMeterName() {
        return "cloudstack.vpn.siteToSite.hours";
    }
}
