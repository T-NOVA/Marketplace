 ...
 */
public class
        McnUsageDataRecordResource extends ServerResource {
    final static Logger logger = LogManager.getLogger(McnUsageDataRecordResource.class.getName());
    private String endpoint = "/mcn/usage";
    private APICallCounter counter = APICallCounter.getInstance();

    public McnUsageDataRecordResource() {
        super();
