...
public class Start {
     ...
     */
    public Start(String command, String templateFile, String templateFileFormat) {
    ...
    public Start withCommand(String command) {
        this.command = command;
        return this;
    }
    ...
    public Start withTemplateFile(String templateFile) {
        this.templateFile = templateFile;
        return this;
    }
    ...
    public Start withTemplateFileFormat(String templateFileFormat) {
        this.templateFileFormat = templateFileFormat;
        return this;
    }
