...
@JsonPropertyOrder({
    ...
    "instantiation_end_time",
    "instantiation_start_time",
...
public class NetworkServiceInstantiateReply {
    ...
    private List<Object> auditLog = new ArrayList<Object>();
    ...
    private List<Object> lifecycleEventHistory = new ArrayList<Object>();
    ...
    private String marketplaceCallback;
    ...
    private List<Object> resourceReservation = new ArrayList<Object>();
    ...
    /**
     * 
     * @param descriptorReference
     * @param marketplaceCallback
     * @param lifecycleEventHistory
     * @param instantiationEndTime
     * @param networkStack
     ...
     * @param serviceDeploymentFlavour
     * @param vnfrs
     * @param updatedAt
     * @param vnffgd
     * @param instantiationStartTime
     * @param vlr
     * @param runtimePolicyInfo
     */
    public NetworkServiceInstantiateReply(List<Object> auditLog, AutoScalePolicy autoScalePolicy, List<Object> connectionPoints, String createdAt, String descriptorReference, String instantiationEndTime, String instantiationStartTime, List<Object> lifecycleEventHistory, LifecycleEvents lifecycleEvents, String mappingTime, String marketplaceCallback, List<MonitoringParameter> monitoringParameters, String notification, String nsdId, List<Object> resourceReservation, List<Object> runtimePolicyInfo, String serviceDeploymentFlavour, String status, String updatedAt, String vendor, String version, List<Vlr> vlr, List<Object> vnfDepedency, Vnffgd vnffgd, List<Vnfr> vnfrs, String id, NetworkStack networkStack, VnfInfo vnfInfo) {
     ...
     */
    @JsonProperty("audit_log")
    public List<Object> getAuditLog() {
        return auditLog;
    }
     ...
     */
    @JsonProperty("audit_log")
    public void setAuditLog(List<Object> auditLog) {
        this.auditLog = auditLog;
    }

    public NetworkServiceInstantiateReply withAuditLog(List<Object> auditLog) {
        this.auditLog = auditLog;
        return this;
    }
     ...
     * 
     * @return
     *     The lifecycleEventHistory
     */
    @JsonProperty("lifecycle_event_history")
    public List<Object> getLifecycleEventHistory() {
     ...
     * 
     * @param lifecycleEventHistory
     *     The lifecycle_event_history
     */
    @JsonProperty("lifecycle_event_history")
    public void setLifecycleEventHistory(List<Object> lifecycleEventHistory) {
        this.lifecycleEventHistory = lifecycleEventHistory;
    }

    public NetworkServiceInstantiateReply withLifecycleEventHistory(List<Object> lifecycleEventHistory) {
        this.lifecycleEventHistory = lifecycleEventHistory;
        return this;
    }
     ...
     * 
     * @return
     *     The marketplaceCallback
     */
    @JsonProperty("marketplace_callback")
    public String getMarketplaceCallback() {
     ...
     * 
     * @param marketplaceCallback
     *     The marketplace_callback
     */
    @JsonProperty("marketplace_callback")
    public void setMarketplaceCallback(String marketplaceCallback) {
        this.marketplaceCallback = marketplaceCallback;
    }

    public NetworkServiceInstantiateReply withMarketplaceCallback(String marketplaceCallback) {
        this.marketplaceCallback = marketplaceCallback;
        return this;
    }
     ...
     */
    @JsonProperty("resource_reservation")
    public List<Object> getResourceReservation() {
     ...
     * 
     * @param resourceReservation
     *     The resource_reservation
     */
    @JsonProperty("resource_reservation")
    public void setResourceReservation(List<Object> resourceReservation) {
        this.resourceReservation = resourceReservation;
    }

    public NetworkServiceInstantiateReply withResourceReservation(List<Object> resourceReservation) {
        this.resourceReservation = resourceReservation;
        return this;
    }
     ...
     * 
     * @param serviceDeploymentFlavour
     *     The service_deployment_flavour
     */
    @JsonProperty("service_deployment_flavour")
    ...
    public NetworkServiceInstantiateReply withNetworkStack(NetworkStack networkStack) {
        this.networkStack = networkStack;
        return this;
    }
    ...
    public NetworkServiceInstantiateReply withVnfInfo(VnfInfo vnfInfo) {
        this.vnfInfo = vnfInfo;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(auditLog).append(autoScalePolicy).append(connectionPoints).append(createdAt).append(descriptorReference).append(instantiationEndTime).append(instantiationStartTime).append(lifecycleEventHistory).append(lifecycleEvents).append(mappingTime).append(marketplaceCallback).append(monitoringParameters).append(notification).append(nsdId).append(resourceReservation).append(runtimePolicyInfo).append(serviceDeploymentFlavour).append(status).append(updatedAt).append(vendor).append(version).append(vlr).append(vnfDepedency).append(vnffgd).append(vnfrs).append(id).append(networkStack).append(vnfInfo).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(auditLog, rhs.auditLog).append(autoScalePolicy, rhs.autoScalePolicy).append(connectionPoints, rhs.connectionPoints).append(createdAt, rhs.createdAt).append(descriptorReference, rhs.descriptorReference).append(instantiationEndTime, rhs.instantiationEndTime).append(instantiationStartTime, rhs.instantiationStartTime).append(lifecycleEventHistory, rhs.lifecycleEventHistory).append(lifecycleEvents, rhs.lifecycleEvents).append(mappingTime, rhs.mappingTime).append(marketplaceCallback, rhs.marketplaceCallback).append(monitoringParameters, rhs.monitoringParameters).append(notification, rhs.notification).append(nsdId, rhs.nsdId).append(resourceReservation, rhs.resourceReservation).append(runtimePolicyInfo, rhs.runtimePolicyInfo).append(serviceDeploymentFlavour, rhs.serviceDeploymentFlavour).append(status, rhs.status).append(updatedAt, rhs.updatedAt).append(vendor, rhs.vendor).append(version, rhs.version).append(vlr, rhs.vlr).append(vnfDepedency, rhs.vnfDepedency).append(vnffgd, rhs.vnffgd).append(vnfrs, rhs.vnfrs).append(id, rhs.id).append(networkStack, rhs.networkStack).append(vnfInfo, rhs.vnfInfo).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
