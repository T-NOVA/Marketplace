...
package org.tnova.service.catalog;
...
public class Application extends SpringBootServletInitializer
{
    ...
    @Override
    protected final SpringApplicationBuilder configure(final SpringApplicationBuilder springApplicationBuilder) {
    ...
    public Docket petApi() {
        return new Docket( DocumentationType.SWAGGER_2).select()
            ...
            .alternateTypeRules( newRule( typeResolver
                .resolve( DeferredResult.class, typeResolver.resolve( ResponseEntity.class, WildcardType.class ) ),
