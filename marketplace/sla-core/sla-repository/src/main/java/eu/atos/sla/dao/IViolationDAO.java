...
public interface IViolationDAO {
	...
	public Date getLastViolationDate(
			IAgreement agreement, String kpiName);

		
	/**
	 * Returns the date of the last violation given an agreement and a kpiName.
	 * 
	 * @param agreement
	 *            of the Violation
	 * @param kpiName
	 *            of the Violation
	 * @return the corresponding date of the violation from the database
	 */
