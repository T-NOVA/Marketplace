...
public class TemplateHelperE  {
	...
	public String createTemplate(eu.atos.sla.parser.data.wsag.ITemplate templateXML, String originalSerializedTemplate)throws DBMissingHelperException, DBExistsHelperException, InternalHelperException, ParserHelperException {
	...
	public ITemplate updateTemplate(String uuid, eu.atos.sla.parser.data.wsag.ITemplate templateXML, String originalSerializedTemplate) 
