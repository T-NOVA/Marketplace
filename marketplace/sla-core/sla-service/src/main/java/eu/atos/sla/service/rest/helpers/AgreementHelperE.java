...
public class AgreementHelperE{
	...
	public String createAgreement(eu.atos.sla.parser.data.wsag.IAgreement agreementXML, String originalSerializedAgreement) throws DBMissingHelperException, DBExistsHelperException, InternalHelperException, ParserHelperException {
	...
	public IContext getAgreementContextByID(String id) throws InternalHelperException {
