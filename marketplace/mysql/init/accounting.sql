...
DROP TABLE IF EXISTS `account_slainfo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `account_slainfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `productId` varchar(26) NOT NULL,
  `agreementId` varchar(26) NOT NULL,
  `productType` varchar(26) NOT NULL,
...
INSERT INTO `django_content_type` VALUES (1,'log entry','admin','logentry'),(2,'permission','auth','permission'),(3,'group','auth','group'),(4,'user','auth','user'),(5,'content type','contenttypes','contenttype'),(6,'session','sessions','session'),(7,'account','account','account'),(8,'monitor','account','monitor'),(9,'billing event','account','billingevent'),(10,'sla info','account','slainfo'),(11,'sla violation','account','slaviolation'),(12,'sla penalty','account','slapenalty');
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2016-08-22 08:07:44'),(2,'auth','0001_initial','2016-08-22 08:07:45'),(3,'admin','0001_initial','2016-08-22 08:07:45'),(4,'sessions','0001_initial','2016-08-22 08:07:45');
...
-- Dump completed on 2016-08-22 11:57:18
